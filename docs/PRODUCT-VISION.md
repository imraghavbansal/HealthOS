# Raag — Product Vision (North Star)

This is the standing product context for Raag. Read this before making any
...
Raag is not "an AI health chatbot," "a record locker," "a tracker," or "a
...
Flywheel: more data → better context → more useful Raag → more usage → more
...
- **Inherited family history** — ancestry/genetic risk info entered about
  relatives who are not Raag users themselves (mother's hypothyroidism,
  paternal CAD). Free-text, informational, feeds the risk engine only.
- **Family circle / household** — living people who *are* Raag subjects
...
log a med, record sleep, add an appointment, talk to Raag, add a family
...
original PDF/scan is the source of truth; anything Raag parses out of it
...
*extracted information*, and *AI interpretation*. Raag never pretends to be
a doctor.
...
> Raag becomes the place where a person and their family build a lifelong,
