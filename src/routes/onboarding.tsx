        ...
        <div className="rounded-3xl glass p-8 md:p-10">
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <p className="text-sm text-muted-foreground">Pick as many as you like. Atlas tailors your dashboard around them.</p>
          ...
          {step === 2 && (
            <div className="space-y-6">
              ...
              <p className="text-sm text-muted-foreground">Optional but powerful — helps Atlas surface inherited risk factors. Comma-separate multiple conditions.</p>
              {family.map((f, i) => (
          ...
          <div className="mt-10 flex items-center justify-between">
            ...
            <Button onClick={finishStepAndAdvance} disabled={saving} className="rounded-full gradient-primary text-white border-0 shadow-soft">
              {saving ? "Saving…" : step === STEPS.length - 1 ? "Finish & enter Atlas" : "Continue"} <ArrowRight className="ml-1 h-4 w-4" />
            </Button>
          </div>
        </div>
