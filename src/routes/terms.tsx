...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service — Orvana" },
      { name: "description", content: "The terms that govern your use of Orvana." },
    ],
  }),
  component: Terms,
});
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-sm leading-relaxed text-foreground/90">
          <section>
            <p>
              These terms govern your use of Orvana (the "Service"). By creating an account, you agree to
          ...
          <section>
            ...
            <p>
              Orvana is an informational tool that helps you organize, track, and understand your own health
              information. <b>It does not diagnose, prescribe, or provide medical advice.</b> Nothing Orvana or its AI
            ...
            <p className="mt-3">
              <b>If you're experiencing a medical emergency, do not rely on Orvana.</b> Call your local emergency
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>You must be at least 18 years old to create an Orvana account. You may add health information for a dependent (a minor child, or an adult you're legally authorized to act for) through your own account — see our Privacy Policy for details.</li>
              ...
              <li>One account per person. Don't share your login with someone else — if you want to share access, use Orvana's built-in sharing controls instead.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              <li>Attempt to access another user's account or data without authorization, or attempt to circumvent Orvana's access controls.</li>
          ...
          <section>
            ...
            <p>
              You own the health information you put into Orvana. We don't claim ownership over it, and we don't sell
          ...
          <section>
            ...
            <p>
              Orvana's AI assistant and document parsing are informational aids grounded in your own data — they cite
          ...
          <section>
            ...
            <p>
              Orvana currently offers a free tier. Paid subscription plans are planned but not yet available at the
          ...
          <section>
            ...
            <p>
              ...
              guarantee it will be error-free or uninterrupted. To the maximum extent permitted by law, Orvana isn't
          ...
          <section>
            ...
            <p>
              ...
              use Orvana afterward means you accept the update.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Questions about these terms: <span className="font-medium">support@orvana.app</span>{" "}
          ...
          <p className="text-xs text-muted-foreground pt-6 border-t border-border/60">
            These terms describe Orvana's actual current practices as of the date above and are written to be
