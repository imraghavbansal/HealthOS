...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How Raag collects, stores, protects, and lets you control your data." },
    ],
  }),
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 prose-sm">
        ...
        <div className="space-y-10 text-sm leading-relaxed text-foreground/90">
          <section>
            <p>
              Raag ("Raag," "we," "us") provides a personal health record and AI assistant product. This
            ...
            <p className="mt-3 font-medium">
              Raag is informational only and is not a substitute for professional medical advice, diagnosis, or
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><b>Conversations with Raag's AI assistant</b> — your questions and the assistant's answers, stored so you can revisit them.</li>
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              Raag's sharing controls — nothing is shared by default.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>Granular consent controls — you decide whether Raag can reference your family history for AI insights, whether de-identified data can help improve the product (off by default), and whether a summary is shared with your care provider.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              <li><b>Access &amp; export</b> — download a complete copy of everything Raag has stored about you.</li>
          ...
          <section>
            ...
            <p>
              Raag supports an adult account holder managing health records for a dependent (e.g. a child or an
          ...
          <section>
            ...
            <p>
              Raag accounts are intended for adults (18+). We don't knowingly allow children to create their own
          ...
          <section>
            ...
            <p>
              ...
              before it takes effect. Continuing to use Raag after a change takes effect means you accept the
          ...
          <section>
            ...
            <p>
              Questions about this policy or your data: <span className="font-medium">privacy@raag.app</span>{" "}
          ...
          <p className="text-xs text-muted-foreground pt-6 border-t border-border/60">
            This policy describes Raag's actual current data practices as of the date above. It is not a substitute
            for independent legal review — as Raag grows, formal certifications and signed data-processing
