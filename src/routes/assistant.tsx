...
function Assistant() {
  ...
  return (
    <AppShell title="Atlas Assistant" subtitle="Ask anything about your health. I'll cite the reports I use.">
          ...
          <CardContent className="p-0 flex flex-col flex-1 min-h-0">
            ...
            <div className="border-t border-border/60 p-4 md:p-6">
              ...
              <p className="text-[10px] text-muted-foreground mt-2 text-center">
                Atlas provides informational insights and can make mistakes. Not a substitute for medical advice.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <StaggerItem>
            <Card className="rounded-3xl border-border/60 gradient-hero">
              <CardContent className="p-5">
                ...
                <div className="text-sm font-semibold mt-1">Atlas Copilot v4</div>
    ...
    <Popover>
      ...
      <PopoverContent className="w-64 rounded-2xl">
        ...
        <p className="text-[11px] text-muted-foreground mt-2 leading-relaxed">
          This answer is grounded in your own uploaded records — Atlas doesn't invent sources.
        </p>
      </PopoverContent>
    </Popover>
  );
