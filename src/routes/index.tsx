        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm text-muted-foreground">
            {[
              ...
              <a key={item.href} href={item.href} className="group relative py-1 hover:text-foreground transition">
                {item.label}
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/signup">
              <Button className="rounded-full gradient-primary text-white shadow-soft border-0 transition-transform hover:scale-105 active:scale-95">Get started</Button>
            </Link>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-16 md:pt-28 pb-20 md:pb-32 text-center">
          ...
          <Reveal delay={0.24}>
            <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
              <Link to="/signup">
                <Button size="lg" className="group rounded-full gradient-primary text-white shadow-soft border-0 h-12 px-6 transition-all hover:scale-[1.03] active:scale-95">
                  Start free — 60 seconds <ArrowRight className="ml-1.5 h-4 w-4 transition-transform group-hover:translate-x-1" />
                </Button>
              </Link>
              <a href="#features">
                <Button size="lg" variant="outline" className="rounded-full h-12 px-6 border-border/60 transition-all hover:border-primary/50 hover:-translate-y-0.5">
                  See how it works
                </Button>
              </a>
            </div>
          ...
          <Reveal delay={0.3}>
            <div className="mt-6 flex items-center justify-center gap-2 text-xs text-muted-foreground">
              ...
              <a href="#privacy" className="underline decoration-dotted underline-offset-2 hover:text-foreground transition">
                ...
                <Reveal delay={0.3}>
                  <div className="mt-3 text-sm bg-card rounded-2xl p-4 border border-border/60 shadow-soft">
                    ...
                    <div className="mt-3 flex flex-wrap gap-1.5">
                      <span className="text-[10px] px-2 py-0.5 rounded-full bg-accent/60 border border-border transition-colors hover:border-primary/50 hover:bg-primary/10 cursor-default">Lipid Panel · Aug 15</span>
                      <span className="text-[10px] px-2 py-0.5 rounded-full bg-accent/60 border border-border transition-colors hover:border-primary/50 hover:bg-primary/10 cursor-default">CBC · Nov 12</span>
                      <span className="text-[10px] px-2 py-0.5 rounded-full bg-accent/60 border border-border transition-colors hover:border-primary/50 hover:bg-primary/10 cursor-default">Family History</span>
                    </div>
                  </div>
                </Reveal>
              </div>
        ...
        <Lift className="rounded-3xl glass p-8 md:p-14 text-center">
          ...
          <Stagger className="mt-8 grid sm:grid-cols-3 gap-3 max-w-3xl mx-auto text-left">
            {["Per-user data isolation", "Granular consent controls", "One-tap export & deletion"].map((t) => (
              <StaggerItem key={t}>
                <div className="rounded-2xl bg-card/60 border border-border/60 px-4 py-3 text-sm transition-colors hover:border-primary/40 hover:bg-card cursor-default">✓ {t}</div>
              </StaggerItem>
            ))}
          </Stagger>
      ...
      <section id="pricing" className="max-w-4xl mx-auto px-6 py-20 md:py-28 text-center">
        <Reveal>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link to="/signup">
              <Button size="lg" className="rounded-full gradient-primary text-white h-12 px-8 border-0 shadow-soft transition-transform hover:scale-105 active:scale-95">
                Create your Raag
              </Button>
            </Link>
            <Link to="/login">
              <Button size="lg" variant="outline" className="rounded-full h-12 px-8 transition-all hover:border-primary/50 hover:-translate-y-0.5">
                Sign in
              </Button>
            </Link>
          </div>
      ...
      <footer className="border-t border-border/60 mt-10">
        <div className="max-w-7xl mx-auto px-6 py-10 flex flex-wrap items-center justify-between gap-4 text-sm text-muted-foreground">
          ...
          <div className="flex gap-6">
            ...
            <a href="#privacy" className="hover:text-foreground transition">Security & compliance</a>
            <a href="mailto:support@raag.app" className="hover:text-foreground transition">Contact</a>
          </div>
        </div>
      </footer>
    </div>
