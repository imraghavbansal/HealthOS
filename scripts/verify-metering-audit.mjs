...
async function main() {
  const email = `atlas-verify-meter-${Math.random().toString(36).slice(2, 8)}@mailinator.com`;
  ...
  const email2 = `atlas-verify-meter2-${Math.random().toString(36).slice(2, 8)}@mailinator.com`;
